// Chapter 7 - Programming Challenge 2, Movie Profit
// This program modifies Programming Challenge 1 in two ways. 
...
void displayMovie(const MovieData &m)
{
	...
	if (m.revenues >= m.costs)
		cout << "\nFirst year profit: $" 
		     << ((m.revenues - m.costs)/1000000) << " million\n";
	else
		cout << "\nFirst year loss  : $"
		     << ((m.costs - m.revenues)/1000000) << " million\n";
}
