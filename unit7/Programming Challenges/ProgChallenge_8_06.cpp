// Chapter 8 - Programming Challenge 6, Lottery
// This program uses two parallel arrays to store a 5-digit 
// user-entered lottery number and a 5-digit randomly 
// generated winning lottery number. It then compares the
// corresponding digits of the two arrays and reports how
// many digits match.
#include <iostream>
#include <string>
